...
<body style="width: 21cm; height: 29cm; margin: 0px; position: relative;">
    ...
    <div class="px-50 py-50">
        ...
        <section class="px-50 mt-50">
            ...
            <p class="text-justify text-indent lh-1-5">Dalam rangka menunjang kegiatan Akademik Mahasiswa Fakultas Hukum Universitas Pembangunan Nasional "Veteran" Jawa Timur, yang melaksanakan Praktek Kerja Lapangan. Mulai tanggal {{ Carbon\Carbon::parse($data['starting_date'])->locale('id')->isoFormat('D MMMM Y') }} sampai dengan {{ Carbon\Carbon::parse($data['ending_date'])->locale('id')->isoFormat('D MMMM Y') }}.</p>
            @else
            <p class="text-justify text-indent lh-1-5">Dalam rangka menunjang kegiatan Akademik Mahasiswa Fakultas Hukum Universitas Pembangunan Nasional "Veteran" Jawa Timur, yang melaksanakan Praktek Kerja Lapangan.</p>
            @endif
